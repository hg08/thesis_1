...
\paragraph{Molecule sampling from instantaneous interface}\label{para_MS_interface}
The method of sampling the interfacial molecules is as follows. 
...
None of the two methods (MS and IHB) for obtaining the HB dynamics of the interface water molecules 
...
To determine the thickness of the solution/vapor interface of alkali solutions,
