...
vibrational properties from velocity autocorrelation and the method of calculating the VSFG spectra from velocity ACF.
...
The ACF \CHB for the simulated bulk water is shown in Fig.\thinspace\ref{fig:pure_bk_c_from_2_methods} a 
