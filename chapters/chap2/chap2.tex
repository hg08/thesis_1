...
Paragraph \ref{section_SFG_Exp} presents an overview of the available experimental data for VSFG spectra of solution/vapor interfaces.
...
[REWRITE THIS SENTENCE: We assume that the kinetic energy of nuclei is zero and their potential energy is constant in each moment of the dynamics.]
...
\section{Selected experimental data on electrolyte interfaces}\label{section_SFG_Exp}
...
In this chapter, we report the experimental results available on salty solutions containing alkali cations and nitrate (iodide) anions\cite{PS03,AJ12,HuaWei2014}. 
