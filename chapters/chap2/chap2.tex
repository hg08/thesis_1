...
For a system comprised of $N$ atoms, the velocity ACF $C(t)$ for a molecule is\cite{MTD,Dickey1969,TI07} 
\begin{equation}
...
\FloatBarrier
\paragraph{Hydrogen bond population auto-correlation function}\label{para:def_HBP}
