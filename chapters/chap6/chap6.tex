...
in the slab are shown in Fig.s\thinspace\ref{fig:c_and_s_ln_bk_pbc} a and b, respectively.
For both the ADH and AHD definitions, we find that the decay rates of \CHB and \SHB for N--W bonds are much faster 
than that for W--W bonds. From the relation \ref{eq:calculate_hb_lifetime_from_s}, the faster relaxation of \SHB implies that 
...
in Chapter \ref{CHAPTER_Methods}).
...
We call them H-bonds \emph{in the solvation shell}.
...
We consider the correlation functions \CHB and \SHB, from which the HB relaxation time $\tau_\text{R}$ and the HB lifetime $\tau_\text{a}$ can be calculated, respectively.
...
\caption{\label{fig:hbacf_C_sh2_2p}The $c^{(k)}(t)$ of W--W bonds in the solvation shell 
  ...
  As a reference, the \CHB for the 1-\AA water/vapor interface (see Paragraph\thinspace\ref{PARA_IHB} in Chapter \ref{CHAPTER_HBD}) and bulk water are also shown.
...
report the  $c^{(k)}(t)$ of W--W bonds in the solvation shell of cations and I$^-$ at the interfaces of the three alkaline iodide solutions.
...
From Fig.\thinspace\ref{fig:hbacf_C_sh2_2p} b, we found that for all three alkaline iodide solutions, the $c^{(k)}(t)$ for solvation shell water molecules 
...
This result indicates that, for the interface of alkaline iodide solution, the continuum HB lifetime  
...
We believe that this fact is the reason that the HB relaxation of the water molecules at the interface becomes faster as the alkaline iodide concentration increases. 
...
To summarize, we have investigated the effect of alkaline nitrate and alkaline iodide on the HB dynamics
...
\setlength{\abovecaptionskip}{0pt}
\caption{\label{fig:256_LiNO3_hbacf_sh_no3} The function \SHB of W--W and N--W bonds at the 
...
No matter from the ADH or AHD criteria, the average lifetime $\langle\tau_\text{a}\rangle$ of I$^-$--water bonds is shorter than that of N--W bonds.
...
Similar to the definition of the correlation function \CSHB in Eq.\thinspace\ref{eq:C_s_HB} in Chapter \ref{CHAPTER_HBD}, for the H-bonds in an instantaneous interface layer, 
...
RDFs for the alkaline nitrate solutions.
}
\end{figure} % 300 K
\begin{figure}[H] 
\centering
...
The $c^\text{(k)}(t)$ for the second solvation shell H-bonds as computed from two different HB definitions: (a) ADH; (b) AHD. 
...
From the previous paragraph, Fig.\thinspace\ref{fig:c_and_s_ln_bk_pbc} a shows that N--W bonds, or H-bonds in the first solvation shell of nitrate,
...
However, as we can see from Fig.s\thinspace\ref{fig:shb_c_ln_bk_Shell_pbc} a and b, 
...
are calculated. 
The distributions in Fig.s\thinspace\ref{fig:prob_dist_Li_surf_I_surf}--\ref{fig:prob_dist_K_surf_I_surf} indicate
...
Therefore, we choose the second solvation shell.)
...
as computed from two different HB definitions: (a) ADH; (b) AHD.} 
...
\end{figure}
From Fig.s\thinspace\ref{fig:distribution_nhb_ln} and \ref{fig:distribution_nhb_ln_s1}, we find:
(1) For thinner layers (Fig.s\thinspace\thinspace\ref{fig:distribution_nhb_ln} a--c, i.e., $d\le 3$ \AA), 
...
%
(1) From both Fig.s\thinspace\ref{fig:distribution_nhb_lii} and \ref{fig:distribution_nhb_lii_s1}, we find that the ratio of water dangling OH bonds 
...
two clear structural properties of alkaline iodide/vapor interface.
...
We calculated the anisotropy decay of water molecules in ions' solvation shells in alkaline nitrate (alkaline iodide) solution/vapor interfaces. 
...
for bulk alkaline nitrate solution, as shown in Fig.\thinspace\ref{fig:gdr_127_XNO3}. 
...
at the alkaline nitrate (alkaline iodide) solution/vapor interfaces. 
...
and ions (water, \Li, \Na, \K, \I and nitrate ions) in the slab of the alkaline nitrate (iodide) solutions.
...
\section{Summary}
We have investigated the effect of alkaline nitrate and alkaline iodide ions on the HB dynamics
