...
for I$^-$--water bonds. The results of W--W bonds are also included for comparison in both Fig.s\thinspace\ref{fig:X-O_c_lii_xlogscale} 
...
(1) For thinner layers (Fig.s\thinspace\thinspace\ref{fig:distribution_nhb_ln} a--c, i.e., $d=1$, $2$, $3$ \AA), 
...
For the LiI/vapor interface, the distribution $P(n)$ is shown in Fig.s\thinspace\ref{fig:distribution_nhb_lii} a--d and Fig.\thinspace\ref{fig:distribution_nhb_lii_s1}.
%
