...
As we can see in the VSFG calculation, H-bonds play a critical role in the behaviour of bulk water,\cite{Eisenberg1969,Luzar1996,Cabane2005} 
...
We use the auto-correlation function \CHB of the HB population to describe the structural relaxation of H-bonds: 
\begin{eqnarray}
...
%===============================
Another scheme to describe the HB dynamics is the continuum HB population correlation function, or survival probability \cite{AC00} for a newly generated HB.
...
Calculating the reactive flux HB correlation functions and determine the rate constant,
...
For pure water systems, we can compare the results of the current method with the results of 
previous researchers.\cite{AL96,Kessler2015} On this basis, we will show in this paragraphs the result of the HB dynamics of the air-water interface.
...
Fig.\thinspace\ref{fig:128w_bk_itp_50ps_n_from_k_in_with_2_hb_def} a and b
...
Comparing the two figures \ref{fig:128w_bk_itp_50ps_n_from_k_in_with_2_hb_def} a and b,
...
we find that although the trend of change of $C_{HB}$ is the same: as time increases, it gradually decays from 1; 
...
and the IHB method does not require such sampling. Therefore, the IHB method is more coneinient method to determine the HBD of instantaneous interface.
