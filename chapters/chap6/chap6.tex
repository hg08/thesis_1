...
the correlation function \CHB for the water molecules located in the interface and their a statistical average.
...
when we use the method of Molecule Selection (MS) in the interface, the dependence of the correlation function \CHB.  
on the interface thickness is very consistent with that of \CSHB for large $d$. 
