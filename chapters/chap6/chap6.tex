...
For the \LiN/vapor interface with different thickness, the distributions $P(n)$'s are shown in Fig. \ref{fig:distribution_nhb_ln} a--d 
...
(1) For thinner layers (Fig.\thinspace\ref{fig:distribution_nhb_ln} a--c, i.e., $d=1$, $2$, $3$ \AA), 
