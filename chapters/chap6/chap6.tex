...
The data for bulk water are calculated from water in the middle of the slab of LiI solution.
}
\end{figure}
...
(1) For thinner layers (Fig.\thinspace\thinspace\ref{fig:distribution_nhb_ln}(a)(b)(c), i.e., $d\le 3$ \AA), $P(n=0)$ for \LiN solution/vapor interface is smaller than that for the water/vapor interface.
...
The distribution of the number of HBs per OH bond for LiI solution/vapor interface is also calculated and analyzed. 
...
From the probability distribution of ions for LiI
...
To expain the $C_2(t)$ for the \LiN and LiI solution/vapor interfaces, 
