...
In the water/vapor interface, $k(t)$ quickly changes from its initial value in transient period ($\sim 0.2$ ps, see the inset of Fig.\thinspace\ref{fig:121}). 
...
the thickness of the water/vapor interface is about 4 \A. This value is smaller than that obtained from the SFG spectra 
