...
The correlation functions $C^s_{HB}(t)$ for the instantaneous interfacial H-bonds with differnt thickness ($d$), based on water-water 
...
The dependence of (a) the rate constants $k$ and $k'$ and (b) the HB lifetime $\tau_\text{HB}$ on the interface thickness,
...
We also found that when we look at the molecules in the interface whose thickness is less than $d_0$, 
