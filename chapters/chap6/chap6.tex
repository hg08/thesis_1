...
The $C^s_\text{HB}(t)$ for the instantaneous interfacial H-bonds with different thickness ($d$), 
...
The $C_\text{HB}(t)$ for the instantaneous interfacial H-bonds with different thickness $d$,  
