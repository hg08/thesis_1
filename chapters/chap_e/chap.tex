...
over these functions, e.g., $C_{\text{HB},j}(t), j=1,\cdots,n$.
...
In the IHB method, we are very accurate in choosing the interfacial water molecules and interfacial H-bonds, 
