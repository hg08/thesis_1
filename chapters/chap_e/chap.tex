...
LiI solution/vapor interface. We found that when $d$ is equal to 6 \AA the correlation function \SHB of the interface 
...
When \rt is 5 fs, the calculated continuum HB lifetime is 0.30, 0.31 and 0.23 ps, for the interface of LiI, NaI and KI solution, respectively.
