  ...
  \setlength{\abovecaptionskip}{0pt}
  \caption{\label{vdos_4_Li}VDOS for the four water molecules (all water molecules) in the cluster \LiFourW.} 
  ...
  \caption{\label{vdos_4_Li-wat_w1_5ps}VDOS for the water molecules (three water molecules) bound to Li
    in the cluster \LiFourW.} 
  \end{figure}
  %
