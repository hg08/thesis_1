...
In Paragraph \ref{sfg_ln}, the VSFG spectroscopy of the alkali nitrate interfaces of  aqueous solutions is calculated,
...
Fig.\thinspace\ref{fig:sfg_LiNO3_7A_20ps_gauss150}. The calculated intensity spectra show a depletion of the 3200 \cm region as in the experiments.
...
\setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:gdr_124_LiI} RDFs for LiI solution/vapor interface:
...
\setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:gdr_124_NaI} RDFs for NaI solution/vapor interface:
...
\setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:gdr_124_KI} RDFs for KI solution/vapor interface:
...
For the NaI and the KI interfaces, the effects can be seen from Fig.\thinspace\ref{fig:gdr_124_NaI} and \ref{fig:gdr_124_KI}. For \Na and K$^+$, 
...
\caption{\label{fig:sfg_118_2LiI_both_50ps_gauss150}
        ...
        (the same for Fig.\thinspace\ref{fig:sfg_118_2NaI_50ps_gauss150} and\thinspace\ref{fig:sfg_118_2KI_both_50ps_gauss150}).} 
\end{figure} % 0.9 M
