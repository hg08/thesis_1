  ...
  \setlength{\abovecaptionskip}{0pt}
    \caption{\label{fig:clusters_4}The geometry optimized structure of the clusters: (a) [NO$_3\cdot$(H$_2$O)$_3$]$^-$; (b) RNO$_3$(H$_2$O)$_3$; (c) RNO$_3$(H$_2$O)$_4$; (d) RNO$_3$(H$_2$O)$_5$ (R=Li,Na,K). More structural properties are shown in Appendix \ref{structure_of_clusters}.}
  \end{figure}
  ...
  \setlength{\abovecaptionskip}{0pt}
    \caption{\label{gdr_4_Li} The RDFs $g_{\text{Li-O}}$ and $g_{\text{Li-H}}$ for the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$.} 
  \end{figure}
  %
  \begin{figure}[htbp]
  \centering
  ...
  \caption{\label{vdos_4_Li} %old version: vdos_4_Li-wat_2p 
    The VDOS for the four water molecules (all water molecules) in the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$.} 
...
\caption{\label{fig:gdr_3_RNO3} (a) The RDF $g_{\text{R-O}}$ for clusters RNO$_3$(H$_2$O)$_3$ (R=Li, Na, K);
  (b) The RDF $g_{\text{O-H}}$ for clusters RNO$_3$(H$_2$O)$_3$ and [NO$_3\cdot$(H$_2$O)$_3$]$^-$ (no alkali metal cation).}
\end{figure}
%
\begin{figure}[H]
\centering
