  ...
  \setlength{\abovecaptionskip}{0pt}
    \caption{\label{fig:clusters_4}Geometry optimized structure of the clusters: (a) [NO$_3\cdot$(H$_2$O)$_3$]$^-$; (b) RNO$_3$(H$_2$O)$_3$; (c) RNO$_3$(H$_2$O)$_4$; (d) RNO$_3$(H$_2$O)$_5$ (R=Li,Na,K). More structural properties are shown in Appendix \ref{structure_of_clusters}.}
  \end{figure}
  ...
  \setlength{\abovecaptionskip}{0pt}
    \caption{\label{gdr_4_Li}RDFs $g_{\text{Li-O}}$ and $g_{\text{Li-H}}$ for the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$.} 
  \end{figure}
  %
  \begin{figure}[htbp]
  \centering
  \includegraphics[width=0.36\textwidth] {./diagrams/vdos_4_Li} 
  \setlength{\abovecaptionskip}{0pt}
  \caption{\label{vdos_4_Li}VDOS for the four water molecules (all water molecules) in the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$.} 
  %(a) The VDOS for all water molecules (black line), Li-bound (red) and H-bonded water molecules (blue).
  %(b) The VDOS for H-bonded water molecules (blue), and of both Li-bound and H-bonded water molecules (orange). %old version: vdos_4_Li-wat_2p }
  \end{figure}
  %
  ...
  shows that, in this case, there are two types of OH stretching modes in the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$:
  ...
  \caption{\label{vdos_4_Li-wat_w1_5ps}VDOS for the water molecules bound to Li (three water molecules) 
    in the cluster [Li$\cdot$(H$_2$O)$_4$]$^-$.} 
  \end{figure}
  %
...
show that the nitrate is solvated and in particular a stronger HB is formed in the presence of the cation. 
%=============
%MS: added XXX
...
which only bound to the nitrate in the simple cluster [NO$_3\cdot$(H$_2$O)$_3$]$^-$ (3430 \centimeter, see e.g., in Fig.\thinspace\ref{fig:vdos_NO3-3w_2_H6H7}). 
%
%\begin{figure}[h!]
\begin{figure}[H]
\centering
...
\caption{\label{fig:gdr_3_RNO3} (a)RDF $g_{\text{R-O}}$ for clusters RNO$_3$(H$_2$O)$_3$ (R=Li, Na, K);
  (b)RDF $g_{\text{O-H}}$ for clusters RNO$_3$(H$_2$O)$_3$ and [NO$_3\cdot$(H$_2$O)$_3$]$^-$ (no alkali metal cation).}
\end{figure}
%
\begin{figure}[H]
\centering
...
\setlength{\abovecaptionskip}{0pt}
\caption{\label{fig:vdos_LiNO3-3-5w}VDOS for each water molecule in the cluster LiNO$_3$(H$_2$O)$_n$: 
  (a) $n=3$;  (b) $n=4$; (c) $n=5$.
...
\begin{figure}[H]
 ...
 \setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:vdos_Li_Na_K-NO3-3w}VDOS for H$_2$O in clusters (a) LiNO$_3$(H$_2$O)$_3$, (b) NaNO$_3$(H$_2$O)$_3$ and (c) KNO$_3$(H$_2$O)$_3$.  
