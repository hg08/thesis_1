...
The DFT calculations were done with the CP2K program, which incorporates the Gaussian and Plane Waves (GPW) method\cite{GL99}. 
...
Simulations on alkali nitrate solutions were performed at 300 K within the canonical NVT ensemble. 
