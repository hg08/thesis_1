...
\caption{\label{fig:sfg_118_2LiI_both_50ps_gauss150}
        ...
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of the LiI solution (solid line) and water/vapor interface (dashed line).
...
\caption{\label{fig:sfg_118_2NaI_50ps_gauss150}
        ...
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of the NaI solution (solid line) and water/vapor (dashed line) interface. 
       } 
...
\caption{\label{fig:sfg_118_2KI_both_50ps_gauss150} 
        (a) Im$\chi^{(2),R}_{SSP}$ and 
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of the KI solution (solid line) and water/vapor interface (dashed line).}
\end{figure} % 0.9 M
%
...
Compared with thw water/vapor interface, the OH-bonded peak of $|\chi^{(2),\text{R}}_{SSP}|^2$ for NaI solution is blue-shifted, 
which is consistent with experimental results on NaI solutions. \cite{EAR04,CST11,LiuDingfang2004,AJ12}
The H-bonded OH-stretching peak of $|\chi^{(2),\text{R}}_{SSP}|^2$ for LiI and KI solution are also blue-shifted. 
...
which can be explained as consequence of the double layer formed by the \I ions on
