\chapter{Hydrogen bond dynamics at the water/vapor interface}\label{CHAPTER_HB}
...
\section{Summary}
In this chapter, we have introduced the interfacial HB population operators, 
and various correlation functions \CHB, \SHB, $n(t)$, and $k(t)$ based on these operators. 
The HB dynamics calculations for bulk water and the water/vapor interface are based on these correlation functions. 
...
We have studied the HB dynamics for instantaneous interfaces using two different statistical methods, the MS and the newly introduced IHB.
We have found that as the interface thickness increases, 
the HB reaction rate constants tend to the rate constants in bulk water.
...
(Ref. paragraph \thinspace\ref{sfg_lino3_interface}) for the \LiN/vapor interface, and this result has reference significance for our study of the influence of ions on the H-bonds 
