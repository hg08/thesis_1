...
Until now, we have analyzed the behaviour of a salty water/vapor interface containing \LiN.
...
\caption{\label{fig:sfg_118_2LiI_both_50ps_gauss150}
        ...
        The data for pure water/vapor interface is calculated from the DFTMD simulation for the water interface with the same thickness (5 \AA). 
        The same below.} 
\end{figure}
