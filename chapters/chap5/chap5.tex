...
\caption{\label{fig:interface_chandler}Water/vapor interfaces of \LiN solution and pure water. 
...
\setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:sfg_LiNO3_7A_20ps_gauss150} (a) Im$\chi^{(2),\text{R}}_{SSP}$ and (b) $|\chi_{SSP}^{(2),\text{R}}|^2$ of water molecules 
...
This is consistent with many of the previous results from MD simulations \cite{Dang2002,Jungwirth2001} and Experimental Results for the increase in surface tension relative to neat water for aqueous solutions of sodium halide salts.\cite{Jungwirth2002,Vrbka2004,Garrett2004,Bajaj2016}
\begin{table}[htbp]
\centering
\caption{\label{tab:gdr_Li-water} 
Peaks of $g_{\text{Li-O}}$ and $g_{\text{Li-H}}$ for 0.9 M LiI solution at 330 K. (unit:\A, the same below)}
\begin{tabular}{ccc}
...
\begin{table}[htbp]
  ...
  Peaks of $g_{\text{Na-O}}$ and $g_{\text{Na-H}}$ for 0.9 M NaI solution at 330 K.}
  \begin{tabular}{ccc}
...
\begin{table}[htbp]
    ...
    Peaks of $g_{\text{K-O}}$ and $g_{\text{K-H}}$ for 0.9 M KI solution at 330 K.}
    \begin{tabular}{ccc}
...
In view of the close relationship between the hydrogen bond network of the solution interface and the properties of the solution, 
