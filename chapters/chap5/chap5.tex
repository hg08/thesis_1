...
at water/vapor interface of \LiN solution.} 
...
\caption{\label{fig:surf_x-vs-l_x_d1-5}VDOS $g_z(\nu)$ of water molecules at the interface of LiNO$_3$ solution 
  (solid line) and at water-vapor interface (dashed line). (a): $d=1$ \A; (b): $d=2$ \A; (c): $d=5$ \A.}
\end{figure}
%
...
It indicates that a Hydrogen Bond (HB) with nitrate acceptor is weaker than that with water acceptor. 
...
A model for the water/vapor interface is built, in which a slab of 118 water molecules containing two \Li cations and 
...
\caption{\label{fig:prob_124_LiI_double_axis}Probability distributions $P(z)$, along the normal direction, 
  of \li, I$^-$ and O in LiI solution-air interface.}
...
\begin{table}[htbp]
    ...
    Peaks of $g_{\text{K-O}}$ and $g_{\text{K-H}}$ for 0.9 M KI solution.}
    \begin{tabular}{ccc}
...
The calculated VSFG spectra for LiI, NaI and KI interfaces, as shown in Fig.\thinspace\ref{fig:sfg_118_2LiI_both_50ps_gauss150} to \ref{fig:sfg_118_2KI_both_50ps_gauss150}. 
...
\caption{\label{fig:sfg_118_2LiI_both_50ps_gauss150}
        ...
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of 0.9 M LiI solution (solid line) and water/vapor interface (dashed line).
...
\caption{\label{fig:sfg_118_2NaI_50ps_gauss150}
        ...
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of 0.9 M NaI solution (solid line) and water/vapor (dashed line) interface. 
       }
...
\caption{\label{fig:sfg_118_2KI_both_50ps_gauss150} 
        (a) Im$\chi^{(2),R}_{SSP}$ and 
        (b) $|\chi^{(2),\text{R}}_{SSP}|^2$ of the interface of 0.9 M KI solution (solid line) and water/vapor interface (dashed line).}
\end{figure}
%
...
It can be seen that indeed the spectra are very close to each other.
From the results of the nonlinear susceptibilities, we conclude that water molecules at the interfaces of LiI, NaI, and KI solutions are participating 
in weaker H-bonds, compared with those at the water-vapor interface. 
The simulation results permit to interpret the features present in the experimental spectra, which can be explained as consequence of the double layer formed by the \I ions on
