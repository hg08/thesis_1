...
Compared to bulk atoms or molecules, interfacial atomic or molecular layers generally have very different optical properties. 
...
We are concentrated on the liquid/water interface of alkali metal nitrate and alkali metal halide solutions.
...
Hydrogen bond (HB) dynamics is studied for the water/vapor and solution/vapor interfaces to obtain the structural characteristics of the solution/vapor interfaces.
...
To represent the interface at molecular level, the technique for calculating instantaneous liquid interface are used to define a liquid interfae from atomic coordinates.
...
such as the thickness of the water/vapor interface, the relaxation time of the hydrogen bond at the interface, 
...
In chapter \ref{CHAPTER_Methods}, we present the methods of \abinitio Molecular Dynamics and one of its implementations---the DFT
...
In chapter \ref{CHAPTER_Clusters}, we present the results of the vibrational properties of water clusters including alkali metal nitrates, 
...
In addition to the alkali nitrate solutions, in chapter \ref{CHAPTER_HBD_Solutions}, we also simulated and analyzed the alkali iodide solutions and its interface, which have similar properties in many aspects. 
