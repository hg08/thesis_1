...
CO$_3^{2-}$ $>$  SO$_4^{2-}$ $>$ F$^-$ $>$ Cl$^-$ $>$ Br$^-$ $>$ NO$_3^-$ $>$ I$^-$ $>$ ClO$_4^-$ $>$ SCN$^-$\cite{PJ06,Pegram2007,ZYJ10,DT08,Parsons2011,HuaWei2013}. 
...
In the analysis of the DFTMD simulations, to selectively address the interface, I 
