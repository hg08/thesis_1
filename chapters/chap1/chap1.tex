...
Its sign is also closely related to the orientation of molecules at the interface\cite{TianCS08,TianCS09,TianCS2011}.
...
orientation distribution, and the VSFG spectrum.  
...
The results show that they have some common characteristics: the H-bonded OH-stretching peak of $|\chi^{(2),\text{R}}|^2$ for the three solutions are
