...
%from different H-bonded species in the sample.\cite{Pieniazek11}
%%[Done]O: 
...
%the VSFG signal, is a result of cancellation between the positive contributions from four-H-bonded
...
as the auto-correlation function (ACF) of the velocity of atoms. 
