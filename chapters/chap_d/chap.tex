...
Hydrogen bond lengths $r_a$ in [NO$_3\cdot$(H$_2$O)$_3$]$^-$.} % T=300 K. 
...
%\begin{figure}[H]
%\centering
%\includegraphics [width=0.4\textwidth] {./diagrams/vdos_NO3-3w_2_H-wat}%
%\setlength{\abovecaptionskip}{0pt}
...
\section{Solution/vapor interfaces}
...
%\caption{\label{fig:prob_theta_ln_itp_256} The dipole orientation distribution of water molecules at the water/vapor and the LiNO$_3$ solution/vapor interfaces.}
%\end{figure}
%
...
which comes from Hydrogen--Iodide bond at the interfaces and the existence of free OH stretching.
...
\caption{\label{tab:fitting_c2_for_each_type_of_water}%
	Biexponential fitting of $C_2(t)$ for water molecules in the LiI solution. 
