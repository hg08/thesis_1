...
%surface propensity for the solution/vapor interface, for example \nitrate  and  \I ions.]
...
In Chapter \ref{CHAPTER_HBD} we have shown that,
...
%[Using the correlation functions based on the interfacial hydrogen bond (IHB) population operator, we have calculated the HB dynamics of water layer with a certain thickness under the instantaneous surface.  REFORMULATE THIS SENTENCE.]
...
%The main difference of this distribution between alkali nitrate (iodide) solution/vapor interfaces and the water/vapor interface 
...
%\paragraph{Discussion} We use DFT based molecular dynamics simulations to model alkali nitrate and alkali iodine solutions, and calculate the SFG spectra, HB dynamics and 
