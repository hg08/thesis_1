...
The time dependence of the population functions $n(t)$ for bulk water and the water/vapor interface from (a) ADH (b) AHD criteria. ($T=300$ K.)} 
\end{figure}
...
Then, the $\tau_{2,i}$ represent the relaxation time of the $C_2(t)$. 
...
The slower correlation time indicates that the water molecules are held more rigidly within the 1st hydration shell of \Na ions.}
\end{figure}
%
