...
\begin{figure}
\centering
\includegraphics [width=0.6\textwidth] {./diagrams/C2_ln_bk}
\setlength{\abovecaptionskip}{0pt}
\caption{\label{fig:C2_ln_bk}The $C_2$ of water in the solvation shell of Nitrate in bulk LiNO3 Nitrate solution.}
\end{figure}
