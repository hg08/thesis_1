...
we calculated the correlation functions \CHB, $n(t)$, and $k(t)$, and obtained the rate constants with the HB formation and breakage, 
...
Based on the simulations, the MS method % (i.e., select the water molecules in a certain thickness under the interface according to the molecular label)
