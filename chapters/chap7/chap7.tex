...
\paragraph{Nitrate water solutions}
...
Similar to the definitions of the correlation function \CSHB, which we have defined in Eq.\thinspace\ref{eq:C_s_HB}, for the H-bonds in an instantaneous interface layer, 
...
We calculated the HB dynamics for the H-bonds between water molecules in the first solvation shell and molecules in the second solvation shell. 
...
Therefore, the increasing density of O--H$\cdots$I bonds, and decreasing density of water dangling OH bonds is the two clear structural propensities of alkali iodide solution/vapor interface.
