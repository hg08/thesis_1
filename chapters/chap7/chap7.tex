...
Then in paragraph \ref{HBD_SHELL}, we study the HB dynamics and HB lifetime in the solvation shells of the ions.
In paragraph \ref{RAD_SHELL}, we focus on the reorientation dynamics of water molecules in the solvation shells in the solutiona and the interfacial system.
...
and the instantanous surface in the simulated air-water interface of LiNO$_3$ solution. We found that when the system reaches an equilibrium state, 
...
The $\ln{S_\text{HB}(t)}$ for the water--water H-bonds and nitrate--water H-bonds at the water/vapor interface of the \LiN solution is shown in 
...
As shown in Fig.\thinspace\ref{fig:vdos_LiNO3-256w_w_near_nitrate} in Chapter\thinspace\ref{CHAPTER_SFG_Calulation}, 
...
(see Fig.\thinspace\ref{fig:gdr_127_LiNO3}b). We have used $\phi^c = 30^{\circ}$ for the anglar cutoff.\cite{Chowdhuri2006}
...
for I$^-$--water H-bonds. The results of water--water H-bonds are also included for comparison in both Fig.\thinspace\ref{fig:X-O_c_lii_xlogscale} 
...
The time scales of the relaxation of these I$^-$--water H-bonds are obtained for both definitions. 
...
\FloatBarrier
\section{Solvation shell HB dynamics} \label{SHB}
...
Similar to the $C^s_\text{HB}(t)$ for the H-bonds in instantaneous interfaces, for a given $r_\text{shell}$,
...
Like $C^s_\text{HB}(t)$, $C^k_\text{HB}(t)$ show that the HB dynamics is accelerated to a certain extent. 
...
This result is consistent with the calculations from Ishiyama and Morita\cite{TI07,TI14}.
...
\FloatBarrier
\section{Anisotropy Decay in Hydration Shells of Ions}\label{RAD_SHELL}
