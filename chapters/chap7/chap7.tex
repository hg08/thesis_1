...
we also did the same calculations for the electrolyte solutions of alkaline iodides. 
...
Based on the simulations, the traditional molecular sampling method, which we called as MS method, % (i.e., select the water molecules in a certain thickness under the interface according to the molecular label)
