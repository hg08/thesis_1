...
[AIMD data for ML] AIMD trajectories can also be used as datasets for training new potentials for new interfacial systems, which may accerate simulations.
