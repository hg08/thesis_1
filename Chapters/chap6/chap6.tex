...
The average continuum HB lifetime $\tau_{\text{HB}}$ is calculated by the integration of \SHB over $t$). In practice, we have 
\begin{eqnarray}
...
\end{table} 
%Water/Vapor & -&-&
Table \ref{tab:tau_hb_alkali_iodine} shows that, for all three alkali-iodine solutions, the continuum HB lifetime $\tau_{\text{HB}}$ in the 
