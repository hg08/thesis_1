...
This value can be roughly seen from Figure \ref{fig:pure_bk_and_itp_k}, which redraws the $k(t)$ in Figure \ref{fig:pure_bk_c_n_k} and 
Figure \ref{fig:128w_itp_c_n_k} in double logarithmic coordinates and compares them.
%
\begin{figure}[htbp]
\centering
...
\end{figure}
The results of the correlation functions $C_{HB}(t)$ and $S_{HB}(t)$ for both nitrate--water (N--W) and water--water (W--W) hydrogen bonds are shown in Figure \ref{fig:c_and_s_ln_bk_pbc}(a) and (b), respectively.
...
in a periodic cubic box of length $L=15.7787$\AA, which corresponds to a density of (1.11 TO BE CHECKED) g cm$^{-3}$. 
