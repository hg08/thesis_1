...
the aqueous solution containing ions, and the hydrogen bond dynamics in the interface corresponding to the aqueous solution.
...
of water--water hydrogen bonds for \emph{bulk} water, calculated from the trajectory of a DFTMD simulation.
...
of water--water hydrogen bonds for water/vapor \emph{interface} at 300 K, calculated from the trajectory of a DFTMD simulation.
 The definition of $h(t)$ is based on specific H--O bond, instead of water-water pairs.
...
of water--water hydrogen bonds for (a) bulk water and (b) water/vapor interface at 300 K.}
\end{figure}
...
It can be found that the overall trend of n(t) does not depend on the choice of hydrogen bond definition.
...
This feature does not depend on the definitions of the hydrogen bond we choose.
...
\ref{tab:k_k_prime_128w_pure_1} to Table \ref{tab:k_k_prime_128w_pure_4}. 
...
\end{table}
%
In the Table \ref{tab:k_k_prime_128w_pure_1} to \ref{tab:k_k_prime_128w_pure_4}, we performed the fitting in different time region $t_0 < t < 60$ ps
to obtain the forward and backward rate constants ($k$ and $k'$), where $t_0 = 0.2, 0.4, 0.8, 1.6$ ps, respectively. 
We note that on the larger time region, i.e., when $t$ is larger, the value of $\tau_R$ is larger than when $t$ is smaller, 
no matter for the bulk water or the interface. A larger $\tau$ value means that the distance between a water molecule and another water molecule 
...
The time dependence of the correlation functions $C_{HB}(t)$ and $S_{HB}(t)$ (ln$S_{HB}(t)$ is shown) of water--water and nitrate--water hydrogen bonds at 300 K, 
as computed from the ADH (solid line) and AHD (dashed line) criterion of H-bonds. 
The definition of the correlation function is based on the specific hydrogen bond configuration between molecules.} 
\end{figure}
The results of the correlation functions $C_{HB}(t)$ and $S_{HB}(t)$ for both nitrate--water (N--W) and water--water (W--W) hydrogen bonds are shown in Fig. \ref{fig:c_and_s_ln_bk_pbc}(a) and (b), respectively.
For both hydrogen bond definitions, it is found that the decay of the $C_{HB}(t)$ and $S_{HB}(t)$ for nitrate--water hydrogen bonds is much faster 
than that for water--water hydrogen bonds. From the relation \ref{eq:calculate_hb_lifetime_from_s}, the faster relaxation of $S_{HB}(t)$ implies that 
...
Fig.\ref{fig:128w_bk_2delta_t_60ps_water_pair_c_ns40} shows the correlation function $C_{HB}(t)$ defined by $C_{HB}(t) = \langle h(0)h(t)\rangle/\langle h \rangle$ 
...
The correlation functions $C_{HB}(t)$ for bulk water, based on water-water pair hydrogen bond population operator $h(t)$, 
...
\setlength{\abovecaptionskip}{0pt}
  \caption{\label{fig:c2_2LiI_16_inset} The time dependence of the $C_2(t)$ of OH bonds at the water/vapor interfaces of 0.9 M LiI solution 
    and of neat water (dashed line) at 330 K, calculated by DFTMD simulations. The water/vapor interface of neat water is modeled 
...
In the case of water--water hydrogen bonds, the critical distance of $r_{OO}^c=3.5$ \AA are the position of the first minimum of the oxygen--oxygen RDF.
...
\end{figure}
The function $C_{HB}$ of I$^-$--water and water--water hydrogen bonds describes the structural relaxation of these H- bonds. The results of the $C_{HB}(t)$ are shown in Fig. \ref{fig:X-O_c_lii}. 
\begin{figure}[htbp]
\centering
...
for I$^-$--water hydrogen bonds. The results of water--water hydrogen bonds are also included for comparison in both Fig. \ref{fig:wat-wat_s_lii} (a) and (b).
\begin{figure}[htbp]
\centering
