...
Beyond this transient period, the $k(t)$ decays to zero monotonically, and the slop of $\ln{k(t)}$ increases monotonically with $t$ (see Fig.\space\ref{fig:121_log_rf}). 
...
For water/vpaor interfaces of neat water and the aqueous solution interfaces, the fitting results we obtained are plotted in Fig.\thinspace\ref{fig:121_pure_ns20_fit_map}, Fig.\space\ref{fig:124_2LiI_ns20_fit_map},
Fig.\space\ref{fig:124_2NaI_ns20_fit_map}, and Fig.\space\ref{fig:124_2KI_ns20_fit_map}, 
and the optimal values of $k$ and $k'$ given by these results have been listed in Table \ref{tab:k_and_k_prime}. 
These values are comparable in magnitude to those obtained by Ref.\thinspace[{\cite{Khaliullin2013}}] 
Correspondingly, we can find the HB lifetime of the three solution interfaces: $\tau_{\text{HB}} \sim $5--6 ps. 
...
The contour plot of the function $\Delta = \int \big|\ln[kc(t)-k'n(t)] - \ln[k(t)]\big|dt$
for the interfaces of neat water.} 
\end{figure}
% 
\begin{figure}[htbp]
\centering
...
The contour plot of the function $\Delta$ for the interfaces of 0.9 M NaI solution.} 
\end{figure}
%
\begin{figure}[htbp]
\centering
...
The contour plot of the function $\Delta$ for the interfaces of 0.9 M KI solution.} 
\end{figure}
%
\begin{table}[htbp]
\centering
\caption{\label{tab:breaking_reforming_rate} 
    The $k$ and $k'$ for the water/vapor interface of the aqueous solution interfaces.} 
\begin{tabular}{ccc}
\label{tab:k_and_k_prime}
 Interface & $k$ (ps$^{-1}$) & $k'$ (ps$^{-1}$) \\
\hline
  Neat Water & 0.10 $\pm$ 0.02 & 0.20 $\pm$ 0.02 \\
  LiI & 0.10 $\pm$ 0.05 & 0.30$\pm$ 0.05 \\
  NaI & 0.20 $\pm$ 0.10 & 0.30$\pm$ 0.05 \\
  KI  & 0.10 $\pm$ 0.05 & 0.40 $\pm$ 0.10  
\end{tabular}
\end{table}
It can be seen from Table 1 that the HB breaking reaction rate ($k$) at the interface of pure water is basically equivalent to 
