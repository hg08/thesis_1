...
the Coulomb interaction is shielded was already suggested for divalent cation nitrate. [\cite{XM09}]
...
composite partition coefficients ($k_{p,\text{K}^+} = 0.00\pm 0.03$, $k_{p,\text{Na}^+} = 0.05\pm 0.17$, $k_{p,\text{Li}^+} = 0.14\pm 0.18$), [\cite{Pegram06,Pegram08}] i.e., 
...
and for \I in KI interface, $\delta_1 = |2.65 - 3.59| = 0.94$ \A (See Fig.\space\ref{fig:gdr_124_NaI}(b) and \ref{fig:gdr_124_KI}(b)).
