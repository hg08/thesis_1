...
and proposed a new statistical scheme based on the interfacial HB population for the instantaneous interface.
Combining this method with molecule sampling, we can get more realistic and accurate HB dynamics for the water/vapor interface.
