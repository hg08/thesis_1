...
%
Both the measured and calculated VSFG spectra of alkaline nitrate solution show a reduced intensity in the lower frequency portion,
...
This effects is only related to the presence of the nitrate at the water surface and is not affected by the presence of alkali metal ions.
We have shown that, to provide a microscopic interpretation of the spectra,
realistic models of the interface are required to address the perturbation of the ion at the water surface.

Heavier halide anions have a similar effect to nitrate ions on the structure and dynamics of the water/vapor interface.
...
This feature comes from a unique distribution of \I ions and alkali metal cations,
...
The IHB method can also be extended to the solvation shells of ions in aqueous solutions.
...
molecules and the nonlinear susceptibility spectrum $\Im \chi^{(2)}$ of the alkaline nitrate interface.
\end{abstract}
