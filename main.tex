...
Combining this method with selecting molecules on the interface, we can can efficiently obtaine more the HB dynamics of the instantaneous interface. 
Combining this method with selecting the molecules on the interface, we can get more realistic and accurate hydrogen bond dynamics on the interface.
