...
With the help of this operator, one do not need to sample the molecules who are within the instantaneous interface, 
...
This method is also extended to general interface systems, such as the solvation shells of ions in aqueous solutions.
%
The difference between the HB dynamics in the second solvation shell of the \Li and that of nitrate-water Hydrogen (H-) bonds
...
Through solvation shell HB (SHB) dynamics, we obtained the HB dynamics for the H-Bonds between water molecules in the ion's 
second solvation shell. Similarly, we also calculated the reorientation dynamics ($C_2(t)$) of the water molecules in the first solvation shells of ions. 
...
In contrast, the HB dynamics for the H-bonds between water molecules in the second solvation shell are not sensitive to the ions' nature.
\end{abstract}
