...
%
When calculating the SFG spectrum, I used a new approximation method. This method ignores the NR part of the spectrum and finally obtains the interface's nonlinear polarizability to infrared incident light through the velocity correlation function. The theoretical value of the imaginary part of the nonlinear polarizability obtained by this method is the same as the experimental PS-SFG spectrum result.
...
For the water/vapor interface of alkaline iodine solutions, I also find that the cations does not alter the H-bonding network outside the first hydration shell of the cations themselves.
...
\textbf{HSHB} & \textbf{H}ydration \textbf{S}hell \textbf{H}ydrogen \textbf{B}ond\\
