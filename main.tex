...
The calculation of the correlation between the dipole moment and the polarization is 
...
Combining the IHB method with interfacial molecule sampling (IMS), we have obtained more realistic HB dynamics for the water/vapor interface.
This combination gives a method to determine the thickness of the water/vapor interface.
