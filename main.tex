...
%
Both the measured and calculated VSFG spectra of alkali nitrate solution show a reduced intensity in the lower frequency portion of the stretching band,
...
realistic models of the interface are required beyond the simple cluster models.
...
From the results of the simulations and from the calculation of the nonlinear susceptibilities, 
...
The second aspect which we have investigated is the HB dynamics.
...
Combining the IHB method with interfacial molecule sampling (IMS), we have obtained a method to determine the thickness of the water/vapor interface.
The IHB method has been also extended to the solvation shells of ions in aqueous solutions.
...
\begin{extraAbstract}
\addchaptertocentry{\abstractname} % Add the abstract to the table of contents
Die Grenzflächenstruktur und -dynamik von Lösungen, die Alkalinitrate und Alkalihalogenide enthalten, wurden mit Hilfe von auf Dichtefunktionaltheorie basierenden
Molekulardynamik-Simulationen (DFTMD) untersucht. Wir haben eine detaillierte Analyse der Wasserstoffbrückenbindungsstruktur (HB) an der Grenzfläche vorgelegt und
haben die Spektren der Schwingungssummen-Frequenz-Generierung (VSFG) an der Grenzfläche berechnet, um eine molekulare Interpretation der verfügbaren experimentellen Daten zu ermöglichen.

%
Sowohl die gemessenen als auch die berechneten VSFG-Spektren der Alkalinitratlösung zeigen eine verringerte Intensität im unteren Frequenzbereich der Streckbande,
im Vergleich zur Wasser/Dampf-Grenzfläche.
Diese Verringerung wird auf die Wasserstoffbrückenbindungen (H-) zurückgeführt, die zwischen Nitrat und den umgebenden Wassermolekülen an der Grenzfläche entstehen.
...
Schwerere Halogenidanionen, wie z. B. Jod, haben eine ähnliche Wirkung wie Nitrat auf die Struktur und Dynamik der Wasser-Dampf-Grenzfläche.
...
\include{chapters/chap1/chap}
\include{chapters/chap2/chap} 
\include{chapters/chap3/chap} 
\include{chapters/chap4/chap} 
\include{chapters/chap5/chap} 
\include{chapters/chap6/chap} 
\include{chapters/chap7/chap} 
...
\include{chapters/chap_a/chap}
\include{chapters/chap_b/chap}
\include{chapters/chap_c/chap}
\include{chapters/chap_d/chap}
\include{chapters/chap_e/chap}
%
