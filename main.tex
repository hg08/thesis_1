...
\usepackage{pdfpages} % To include CV.pdf into the thesis
%=================================================
%(Re-)New commands
%=================================================
...
\includegraphics[scale=0.5]{./diagrams/uni-mainz_logo}
\end{flushright}
\vspace*{.06\textheight}
...
%---
%CV
%Locatin:  https://www.overleaf.com/project/61ce80a73f346c3552e3b2b5
%---
% If all pages are needed, use
\includepdf[pages=-]{chapters/chap_cv/cv_ganghuang.pdf}
%------------------------------
% If only one page is needed, use
%\includepdf[pages=2]{chapters/chap_cv/cv_ganghuang.pdf}
%----------------------------------------------------------------------------------------
\end{document}  
